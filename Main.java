...
public class Main {
    ...
    public static boolean isBinaryNumber(String input){
        if(input.contains("0")&& input.contains("1") && !invalidNumber(input) || input.contains("0")
            && !invalidNumber(input)||input.contains("1") && !invalidNumber(input)){
            return true;
        }
        return false;
    }
    ...
    public static boolean invalidNumber(String input){
        if(input.contains("2")||input.contains("3")||input.contains("4")||input.contains("5")
